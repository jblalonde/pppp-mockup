...
export default function Composer() {
  return (
    <div className="border-t border-black/5 bg-cream px-3 py-2.5">
      <div className="flex items-center gap-2">
        <div className="flex flex-1 items-center rounded-full bg-cream-card px-4 py-2.5">
          <span className="text-sm text-neutral-400">Écrire un message…</span>
        </div>
        <button className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-forest text-cream transition active:scale-95">
